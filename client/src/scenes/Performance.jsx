...
const Performance = () => {
    ...
    const { data, isLoading } = useGetPerformanceQuery(searchId);
    ...
    return (
        <Box m="1.5rem 2.5rem">
            ...
            <TextField
                label="Search userId: 63701cc1f03239b7f700000e, 63701cc1f03239f09e00018a, 6371251df032398675000196, etc. "
                sx={{ m: "0.5rem 0", width: "50rem" }}
